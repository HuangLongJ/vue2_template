...
export default {
  ...
  computed: {
    list () {
      return [
        {
          src: '/images/components/homePage/introduceOneItem1.png',
        ...
        {
          src: '/images/components/homePage/introduceOneItem2.png',
        ...
        {
          src: '/images/components/homePage/introduceOneItem3.png',
        ...
        {
          src: '/images/components/homePage/introduceOneItem4.png',
          title: 'AI Driven',
    ...
    return (
      <div class="box container-box">
        <div class="content container-content">
          <div class="title big-title">Our advantages</div>
          <div class="tip big-title-tip">
            Key innovations help you achieve break-through with more comprehensive arketing data and organizational
            alignment
          </div>
          <btnBtns class="btns" />
          <div class="list">
...
.box {
  ...
  .content {
    ...
    .list {
      display: grid;
      grid-template-columns: repeat(4, minmax(160px, 252px));
      grid-gap: 40px;
      .list-item {
        overflow: hidden;
        border-radius: 20px;
